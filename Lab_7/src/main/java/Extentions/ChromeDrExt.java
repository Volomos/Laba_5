...
public class ChromeDrExt extends ChromeDriver {
    public ChromeDrExt() throws Exception {
        this(new ChromeOptions());
    }

    public ChromeDrExt(ChromeOptions options) throws Exception {
        this(ChromeDriverService.createDefaultService(), options);
    }

    public ChromeDrExt(ChromeDriverService service, ChromeOptions options) throws Exception {
